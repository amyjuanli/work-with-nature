...
<body>
	...
	<form action="" method="POST">
	    ...
	    <div class="amount">
			...
			<fieldset class="form-group">
			    <div class="form-check">
			        ...
			        <input type="radio" class="form-check-input" name="amount" id="1m2" value="1m2" checked>
			    	1 m2 (€ 2,50)</label>
		    	</div>
		    	<div class="form-check">
				    <label class="form-check-label">
				    <input type="radio" class="form-check-input" name="amount" id="4m2" value="4m2">
				        4 m2 (€ 10,-)
				    </label>
			    </div>
		   		<div class="form-check">
		    		<label class="form-check-label">
		        	<input type="radio" class="form-check-input" name="amount" id="10m2" value="10m2" checked>
		        	10 m2 (€ 25,-)
		    		</label>
		    	</div>
		    	<div class="form-check">
		    		<label class="form-check-label">
		        	<input type="radio" class="form-check-input" name="amount" id="20m2" value="20m2">
		        	20 m2 (€ 50,-)
		    		</label>
		    	</div>
		    	<div class="form-check">
		    		<label class="form-check-label">
		        	<input type="radio" class="form-check-input" name="amount" id="other" value="other">
		        		Otherwise, namely (€): 
		        		<input type="text" id="other_input" name="amount_input" placeholder="€">
		    		</label>
		    	</div>
	  		</fieldset>
		...
		<div class="iban form-check">
		    <label class="form-check-label">
		      <input type="checkbox" class="form-check-input" name="iban-agree">
		      Yes, I agree with the automatic bank draft of Adopt Rainforest
		    </label>

		    <div class="form-group">
			    <input type="iban" class="form-control" id="iban" aria-describedby="iban" placeholder="IBAN *">
		  </div>
		</div> <!-- ./div class="iban" -->
		...
		<div class="form-group">
		    <input type="text" class="form-control" id="insertion" placeholder="Insertion">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
		    <input type="text" class="form-control" id="street" placeholder="Street + Number">
		</div>
		<div class="form-group">
